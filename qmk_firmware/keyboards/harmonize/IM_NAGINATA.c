...
#define NAGINATA_CH_E     NAGINATA_KBIT_P
#define NAGINATA_CH_O     NAGINATA_KBIT_N
#define NAGINATA_CH_YA    NAGINATA_KBIT_SCLN
#define NAGINATA_CH_YU    NAGINATA_KBIT_O
...
static const NAGINATA_BitsToCode_t const naginata_codes_1[] PROGMEM = {
        ...
        DEF_NAGINATA(0,0, \
            VU, HA, TE, SI, __,   __, __, RU, SU, HE, \
            RO, KI, TO, KA, tu,   KU, _A, _I, _U, MINS, \
        ...
        // 拗音同時
        {NAGINATA_KBIT_S | NAGINATA_CH_YA,KANA_KYA},
        {NAGINATA_KBIT_S | NAGINATA_CH_YU,KANA_KYU},
        {NAGINATA_KBIT_S | NAGINATA_CH_YO,KANA_KYO},
        ...
        {NAGINATA_KBIT_X | NAGINATA_CH_YA,KANA_HYA},
        {NAGINATA_KBIT_X | NAGINATA_CH_YU,KANA_HYU},
        {NAGINATA_KBIT_X | NAGINATA_CH_YO,KANA_HYO},
        {NAGINATA_KBIT_D | NAGINATA_CH_YA,KANA_NYA},
        {NAGINATA_KBIT_D | NAGINATA_CH_YU,KANA_NYU},
        {NAGINATA_KBIT_D | NAGINATA_CH_YO,KANA_NYO},
        {NAGINATA_KBIT_W | NAGINATA_CH_YA,KANA_MYA},
        {NAGINATA_KBIT_W | NAGINATA_CH_YU,KANA_MYU},
        {NAGINATA_KBIT_W | NAGINATA_CH_YO,KANA_MYO},
...
static const NAGINATA_BitsToCode_t const naginata_codes_2[] PROGMEM = {
        // 小書き
        {NAGINATA_CH_LHSH | NAGINATA_CH_A,KANA__a},
        {NAGINATA_CH_LHSH | NAGINATA_CH_I,KANA__i},
        {NAGINATA_CH_LHSH | NAGINATA_CH_U,KANA__u},
        {NAGINATA_CH_LHSH | NAGINATA_CH_E,KANA__e},
        {NAGINATA_CH_LHSH | NAGINATA_CH_O,KANA__o},
...
static const NAGINATA_BitsToCode_t const naginata_codes_3[] PROGMEM = {
        ...
        DEF_NAGINATA(NAGINATA_CH_SHFT,NAGINATA_CH_SHFT, \
            __, MI, RI, ME , __,     __, SA , YO, YU, _E, \
            SE, NE, NI, MA , TI,     WA, NO , MO, TU, YA, \
            __, __, WO,COMM, NU,     _O, DOT, MU, HU, __ \
        ),

        // 外来音
        {NAGINATA_KBIT_L | NAGINATA_CH_E | NAGINATA_CH_RDSH,KANA_JE},
        ...
        DEF_NAGINATA(NAGINATA_CH_RDSH,NAGINATA_CH_LDSH, \
            __, BA, DE, JI , __,     __, ZA , __, ZU, BE, \
            ZE, GI, DO, GA , DI,     GU, __ , __, DU, __, \
            BO, BI, GE, GO , ZO,     DA, __ , __, BU, __ \
        ),


        // 半濁音
        {NAGINATA_CH_RHSH | NAGINATA_KBIT_W  ,KANA_PA},
        {NAGINATA_CH_RHSH | NAGINATA_KBIT_X  ,KANA_PI},
        {NAGINATA_CH_LHSH | NAGINATA_KBIT_DOT,KANA_PU},
        {NAGINATA_CH_LHSH | NAGINATA_KBIT_P  ,KANA_PE},
        {NAGINATA_CH_RHSH | NAGINATA_KBIT_Z  ,KANA_PO},

        // 半濁音拗音同時
        {NAGINATA_CH_RHSH | NAGINATA_KBIT_X | NAGINATA_CH_YA,KANA_PYA},
        {NAGINATA_CH_RHSH | NAGINATA_KBIT_X | NAGINATA_CH_YU,KANA_PYU},
        {NAGINATA_CH_RHSH | NAGINATA_KBIT_X | NAGINATA_CH_YO,KANA_PYO},

        // 濁音拗音同時
        {NAGINATA_CH_RDSH | NAGINATA_KBIT_S | NAGINATA_CH_YU,KANA_GYU},
        {NAGINATA_CH_RDSH | NAGINATA_KBIT_S | NAGINATA_CH_YO,KANA_GYO},
        ...
        {NAGINATA_CH_RDSH | NAGINATA_KBIT_X | NAGINATA_CH_YA,KANA_BYA},
        {NAGINATA_CH_RDSH | NAGINATA_KBIT_X | NAGINATA_CH_YU,KANA_BYU},
        {NAGINATA_CH_RDSH | NAGINATA_KBIT_X | NAGINATA_CH_YO,KANA_BYO},
        {NAGINATA_CH_RDSH | NAGINATA_KBIT_S | NAGINATA_CH_YA,KANA_GYA},


        // 外来音
        {NAGINATA_CH_RDSH | NAGINATA_KBIT_K | NAGINATA_CH_A,KANA_VA},
        {NAGINATA_CH_RDSH | NAGINATA_KBIT_K | NAGINATA_CH_I,KANA_VI},
        {NAGINATA_CH_RDSH | NAGINATA_KBIT_K | NAGINATA_CH_E,KANA_VE},
        {NAGINATA_CH_RDSH | NAGINATA_KBIT_K | NAGINATA_CH_O,KANA_VO},
        
        {NAGINATA_CH_SHFT | NAGINATA_KBIT_L | NAGINATA_CH_A,KANA_TULA},
        {NAGINATA_CH_SHFT | NAGINATA_KBIT_L | NAGINATA_CH_I,KANA_TULI},
        {NAGINATA_CH_SHFT | NAGINATA_KBIT_L | NAGINATA_CH_E,KANA_TULE},
        {NAGINATA_CH_SHFT | NAGINATA_KBIT_L | NAGINATA_CH_O,KANA_TULO},
